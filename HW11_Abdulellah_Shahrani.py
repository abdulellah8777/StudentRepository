...
class Repository:
    ...
    def __init__(self, the_dir, ptab=True):
        ...
        db_path = '/Users/abod/Desktop/python/DataBase/810_startup.db'
        ...
        if ptab:
            ...
            print('\nInstructor Summary from the DataBase')
    ...
    def instructor_pre_tab(self):
        ...
        for name in self._instructor.values():
            for i in name.table_rows():
                '''if the instructor have multiple courses'''
                pt.add_row(i)
...
def main():
    the_dir = "/Users/abod/Desktop/python/DataBase"
